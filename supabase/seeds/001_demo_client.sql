...
values ('riverside-dental', 'Riverside Dental', 'dental', 'Demo Client');

insert into client_subscriptions (client_id, capability)
values ('riverside-dental', 'appointment_concierge');
...
values
  ...
  ('riverside-dental', 'appointment_concierge', 'demo-001',
  ...
  ('riverside-dental', 'appointment_concierge', 'demo-002',
  ...
  ('riverside-dental', 'appointment_concierge', 'demo-003',
  ...
  ('riverside-dental', 'appointment_concierge', 'demo-005',
  ...
  ('riverside-dental', 'appointment_concierge', 'demo-006',
  ...
  ('riverside-dental', 'appointment_concierge', 'demo-007',
