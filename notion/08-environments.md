...
| **VAPI assistant** | Casey - Dev | Casey - Staging | Casey (prod) |
...
- VAPI `Casey - Dev` → dev webhook path
- VAPI `Casey - Staging` → staging webhook path
- VAPI `Casey` (prod) → prod webhook path
